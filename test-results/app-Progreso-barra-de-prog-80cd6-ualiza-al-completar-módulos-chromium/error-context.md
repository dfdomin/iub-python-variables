...
- Name: app.spec.js >> Progreso >> barra de progreso se actualiza al completar módulos
- Location: tests/app.spec.js:148:3
...
Expected substring: "1 de"
Received string:    "⚪ 0 de 6 módulos completados"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#progressText')
    14 × locator resolved to <div id="progressText" class="progress-text">⚪ 0 de 6 módulos completados</div>
       - unexpected value "⚪ 0 de 6 módulos completados"

```

```yaml
- text: ⚪ 0 de 6 módulos completados
```
