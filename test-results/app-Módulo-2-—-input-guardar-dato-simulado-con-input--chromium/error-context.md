...
- Name: app.spec.js >> Módulo 2 — input() >> guardar dato simulado con input()
- Location: tests/app.spec.js:29:3
...
Call log:
  ...
  - waiting for locator('#varValue2disp')
    14 × locator resolved to <span class="var-value" id="varValue2disp"></span>
       - unexpected value ""
...
- textbox "Escribe un dato aquí...": "847"
