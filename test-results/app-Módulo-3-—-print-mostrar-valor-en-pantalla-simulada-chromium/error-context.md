...
- Name: app.spec.js >> Módulo 3 — print() >> mostrar valor en pantalla simulada
...
Locator: locator('#screen3')
Expected substring: "Hola IUB"
Received string:    ">>> Esperando print()..."
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#screen3')
    14 × locator resolved to <div id="screen3" class="screen-out">…</div>
       - unexpected value ">>> Esperando print()..."

```

```yaml
- text: ">>> Esperando print()..."
```
