...
- Name: app.spec.js >> Módulo 4 — Mensaje en pantalla >> seleccionar mensaje y mostrarlo
- Location: tests/app.spec.js:55:3
...
Locator: locator('#screen4')
Expected substring: "Reporte generado"
Received string:    ">>> Presiona Ejecutar ↓"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#screen4')
    14 × locator resolved to <div id="screen4" class="screen-out">…</div>
       - unexpected value ">>> Presiona Ejecutar ↓"

```

```yaml
- text: ">>> Presiona Ejecutar ↓"
```
