...
- Name: app.spec.js >> Módulo 5 — f-string >> mostrar mensaje con valor de variable incrustado
- Location: tests/app.spec.js:69:3
...
Locator:  locator('#varBox5 .var-value')
Expected: "92.3"
Received: "78.5"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#varBox5 .var-value')
    14 × locator resolved to <span class="var-value">78.5</span>
       - unexpected value "78.5"
